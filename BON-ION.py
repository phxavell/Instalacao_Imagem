...
#################################################################################################
 ...
 ###    VERIFICAR CAMINHO PARA NOVOS MODELOS ION/GO/A52 HYB NEW
...
###     NECESSÁRIO VERIFICAR NOVO CAMINHO PARA NOVOS MODELOS ION / GO / X E ETC    
    ...
    command = "z:\\construtor\\ION\\ParamBios\\%s.bat " % notebook.get('code')[:8] # Necessário trocar endereço e talvez gerar um codigo novo? Pensar nisso
...
###         VERIFICAR ONDE FICARÁ ARMAZENADO OS LOGS COMPARE PARA OS NOVOS PRODUTOS 2023
...
############################################################################################################################################################    
        ...
        command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\ION\\DriversBon-i7 k:\\ /e /NFL /NDL /NJH /NJS /nc /ns /np"
    
    elif (notebook.get('code')[7] == 'T'):
        command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\ION\\DriversBon-i5 k:\\ /e /NFL /NDL /NJH /NJS /nc /ns /np"
 ...
 ##################################################################################################################################################################   
    ...
    command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\ION\\Manual\\%s\\ w:\\users\\public\\Desktop\\ *.pdf /e" % notebook.get('code')[:4] ########### PARA ACHAR O BOLB MANUAL
