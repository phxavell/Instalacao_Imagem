...
def main():
    ...
    if notebook.get('code')[:3] == "BON":
        command = 'z:\scripts\TFGTools\Intel_BON\UnLockBIOS.bat'
...
"%s"''' % notebook.get('bios_name')
    ...
    logstep("01950 - Write BIOS/UEFI selected parameters")
    ...
    # #################################################
    # TRACK START #####################################
    logstep("02000 - Dump computer's device drivers")
    ...
    # #################################################
    # TRACK START #####################################
    logstep("02550 - Copy Testing tools to Administrator's Desktop")
    ...
    if notebook.get('code')[:3] == "BON":
        command = 'z:\scripts\TFGTools\Intel_BON\LockBIOS.bat'
