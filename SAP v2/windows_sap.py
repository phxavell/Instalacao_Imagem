...
def main():
    ...
    notebook['serialnumber'] = sap.serial(var_os)
...
"%s"''' % notebook.get('bios_name')
    ...
    if notebook.get('os') in ['Windows 11 Pro', 'Windows 11 PRO', 'Windows 11 Professional', 'Windows 11 Home', 'Windows 11 HSL']:
        command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\MOB\\Drivers11 k:\\ /e /NFL /NDL /NJH /NJS /nc /ns /np"
     
    else: 
        command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\MOB\\Drivers10 k:\\ /e /NFL /NDL /NJH /NJS /nc /ns /np"
