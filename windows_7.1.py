...
def main():
    ...
    #command = "z:\\construtor\\ALL\\ParamBios\\teste1.bat " 
    ...
    #linha Original Inacio
    command = "Dism /apply-image /imagefile:Z:\\windows_images\\WIN24H2\\win11pro24h2.wim /index:1 /ApplyDir:W:\ "
    ...
    teste_envio_cbr_interno.copiar_arquivos()
