...
def main():
    ...
    if notebook.get('os') in [
        ...
        notebook['img_matrix'] = 'Z:\\windows_images\\GERAL20210526\\Windows10HSL20h2.wim'
        notebook['img_system'] = 'Z:\\windows_images\\GERAL20210526\\winre.wim'

    elif notebook.get('os') in [
        'Windows 10 Pro'
    ]:
        notebook['img_matrix'] = 'Z:\\windows_images\\GERAL20210526\\Windows10PRO20h2.wim'
        notebook['img_system'] = 'Z:\\windows_images\\GERAL20210526\\winre.wim'
...
"%s"''' % notebook.get('bios_name')
    ...
    # #################################################
    # TRACK START #####################################
    logstep("z01800 - Setting storage device to install the operating system")
    ...
    # Aqui foram apagados os scripts de copia dos drivers somente para este teste
    # do windows_7.py.
    ...
    # #################################################
    # TRACK START #####################################
    logstep("z02200 - Dump data in storage (step 1 of 2)")

    command = "Dism /apply-image /imagefile:" + str(notebook.get('img_system')) + " /index:1 /ApplyDir:S:\ "
    ...
    # #################################################
    # TRACK START #####################################
    logstep("z02200 - Dump data in storage (step 2 of 2)")

    # modo de espera operacional
    time.sleep(5)

    command = "Dism /apply-image /imagefile:" + str(notebook.get('img_matrix')) + " /index:1 /ApplyDir:w:\ "
    ...
    # #################################################
    # TRACK START #####################################
    logstep("z02300 - Windows Recovery and other copy")
