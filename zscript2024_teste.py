...
############################################################################################################################################################    
 ...
 ##################################################################################################################################################################   
    ...
    # B.ON SMART ULTRA 7
        ...
        command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\2024\\BON\\Smart\\DRIVERS k:\\ /e /NFL /NDL /NJH /NJS /nc /ns /np"
    ...
    # modo de espera operacional
        ...
        command = "Dism /apply-image /imagefile:Z:\\windows_images\\IMG_24H2\\WinPRO24h2_Final.wim /index:1 /ApplyDir:W:\ "
        operation = av_factory.cmdexec(command)
    ...
    #══════════════════════════════════════════════════════════════════════════════════════════════════════════ PACOTE DE TESTES MODELO 2024 ══════════════════════════════════════════════════════════════════════════════════════════════════════════════
    '''
    elif 'Virtuo' in notebook.get('os') or 'virtuo' in notebook.get('os'):
        command = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\DesenvolvimentoMao\\TESTES_AVELL_VIRTUO\\ W:\\TESTES_AVELL_VIRTUO /e /NFL /NDL /NJH /NJS /nc /ns /np"
        print ("Copiando arquivos de Testes - VIRTUO")
    '''
    
    if 'Virtuo' in notebook.get('os') or 'virtuo' in notebook.get('os'):
    # Comando para copiar a primeira pasta
        command1 = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\DesenvolvimentoMao\\TESTES_AVELL_VIRTUO\\ W:\\TESTES_AVELL_VIRTUO /e /NFL /NDL /NJH /NJS /nc /ns /np"
        print ("Copiando Testes_Virtuo")
        subprocess.run(command1, shell=True)
    
    # Comando para copiar a segunda pasta
        command2 = "x:\\Windows\\System32\\robocopy.exe z:\\construtor\\DesenvolvimentoMao\\TESTES_AVELL\\ W:\\TESTES_AVELL /e /NFL /NDL /NJH /NJS /nc /ns /np"
        print ("Copiando Testes_Avell")
