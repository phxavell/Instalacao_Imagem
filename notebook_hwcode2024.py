...
database = '''
{
  ...
  "notebooks": [
    ...
    {
      "tela": "14",
      "hw_nome": "Notebook Avell B.ON Smart Ultra 7",
      "hw_code": "BOSMLU7V"
    },
    {
      "tela": "14",
    ...
    {
      "tela": "16",
      "hw_nome": "Notebook Avell STORM 460 i9-14900HX",
      "hw_code": "ST46D149P"
    },
    {
      "tela": "16",
      "hw_nome": "Notebook Avell STORM 460 i7-14650HX",
      "hw_code": "ST46D147P"
    },
    {
      "tela": "16",
...
def nb_tela(var_code):
    for nb in db['notebooks']:
        if var_code.startswith(nb.get('hw_code')):
            return nb.get('tela')
